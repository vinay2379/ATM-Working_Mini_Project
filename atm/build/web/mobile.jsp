...
<html>
  ...
  <div class="form-group">
    ...
    <input name="atm" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter atm number">
  ...
  <div class="form-group">
    ...
    <input name="mobile" type="text" class="form-control" id="exampleInputPassword1" placeholder="Pin">
  </div> <!-- comment -->
