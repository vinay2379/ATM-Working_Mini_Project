...
<html>
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="withrawal" method="post">
  ...
  <div class="form-group">
    ...
    <input name="amount" type="number" class="form-control" id="exampleInputPassword1" placeholder="Amount">
  </div> <br><!-- comment -->
 
  <button type="submit" class="btn btn-primary">Enter Here</button>
  <button type="reset" class="btn btn-primary">Logout</button>
</form>
